...
echo -e "\033[1mEnter public path URL (e.g. https://microbin.myserver.net or http://localhost:8080). Press Enter to leave it empty:\033[0m"
read install_dir
...
mkdir -p $install_dir
cd $install_dir
$download_command https://raw.githubusercontent.com/loongel/microbin/master/.env
$download_command https://raw.githubusercontent.com/loongel/microbin/master/compose.yaml
