...
pub struct Args {
    ...
    #[clap(long, env = "MICROBIN_ACCESS_PASSWORD")]                                                                 
    ...
    #[clap(
        long,
        env = "MICROBIN_RANDOM_PATH_LENGTH",
        default_value_t = 4
    )]
    pub random_path_length: u8,

    #[clap(long, env = "MICROBIN_MODERN_UI")]
    pub modern_ui: bool,

    #[clap(long, env = "MICROBIN_RANDOM_STRINGS")]
    pub random_strings: bool,
}
...
impl Args {
    ...
    pub fn without_secrets(self) -> Args {
        Args {
            ...
            random_path_length: self.random_path_length,
            modern_ui: self.modern_ui,
            random_strings: self.random_strings,
        }
    }
}
